class AfmNextAT0916Next20260816Cd2fdba < Formula
  desc "OpenAI-compatible local LLM API pinned nightly from 20260816"
  homepage "https://github.com/scouzi1966/maclocal-api"
  url "https://github.com/scouzi1966/maclocal-api/releases/download/nightly-20260816-cd2fdba/afm-next-arm64.tar.gz"
  version "0.9.16-next.20260816.cd2fdba"
  sha256 "4b0aaf31d230b8672f10f2a3ef062de4a8111452d2e9fbe5843413412f102519"
  license "MIT"
  version_scheme 1
  ...
  def caveats
    <<~EOS
      This is a pinned historical nightly (20260816).
