class AfmAT095 < Formula
  desc "Apple Foundation Models + MLX local models — OpenAI-compatible API, WebUI, all Swift (pinned v0.9.5)"
  ...
  def caveats
    <<~EOS
      This is a pinned historical release of afm (v0.9.5).
